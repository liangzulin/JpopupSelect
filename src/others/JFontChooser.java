...
public class JFontChooser extends JPanel {
    private static final long serialVersionUID = 123436L;
    ...
    private final JLabel lblFont;//选择字体的LBL
    private final JLabel lblStyle;//选择字型的LBL
    private final JLabel lblSize;//选择字大小的LBL
    private final JLabel lblColor;//选择Color的label
    ...
    private final JButton ok, cancel;//"确定","取消"按钮.
    private final JScrollPane spFont;
    private final JScrollPane spSize;
    private JLabel lblShow;//显示效果的label.
    private final JPanel showPan;//显示框.
    ...
    public JFontChooser(MyFont curFont) {
        ...
        //事件
        lstFont.addListSelectionListener((ListSelectionEvent e) -> {
        ...
        cbColor.addActionListener((ActionEvent e) -> {
