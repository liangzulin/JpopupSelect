...
import org.lzl.compiler.CompileAndRunJavaFile;
import org.lzl.windows.ExecutorForm;
import org.lzl.windows.ImageTextSenderForm;
...
//            ImageTextSenderForm itpf = new ImageTextSenderForm();
//            itpf.setVisible(true);
            
            
//            ComplexCellRenderer2.main2();
        });
//        CompileAndRunJavaFile.main2("D:\\work1\\Main.java", "D:\\work1\\wtfthis");
        CompileAndRunJavaFile.main2("Main.java", "wtfthis.txt");
